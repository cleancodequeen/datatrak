 ...
 *
 *
 * @file           functions-team-profiles.php
 * @package        Datatrak
 * @author         Andrew Nida
 * @copyright      2014 Fig Company
 * @license        license.txt
 * @version        Release: 1.0
 * @filesource     wp-content/themes/datatrak/functions-team-profiles.php
...
if ( !class_exists('ManagementProfiles') ):

class ManagementProfiles
{
	/**
	...
	public function admin_notice() {
		...
		$html .= '<strong>Management Team</strong> needs the <a href="http://www.advancedcustomfields.com/" target="_blank">Advanced Custom Fields</a> plugin to work. Please <a href="' . $install_link . '">install it now</a>.';
		$html .= '</p></div>';
	...
	static function display() {
		...
		$transient_label = __CLASS__ . "_" . __FUNCTION__; // Transient label will be 'ManagementProfiles_display'
...
$ManagementProfiles = new ManagementProfiles();
